 ...
 * @example         lv_obj_add_style(Deletebtn, &style_btn, 0); //Default button style
 * @example         lv_obj_add_style(Deletebtn, &btn_red, LV_STATE_PRESSED); //Overwrite only some colors to red when pressed
 */
