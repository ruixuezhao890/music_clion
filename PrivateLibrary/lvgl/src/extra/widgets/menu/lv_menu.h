...
typedef struct {
    ...
    lv_obj_t *
    main_header_back_btn; /* a pointer to obj that on click triggers back Deletebtn event handler, can be same as 'main_header' */
    lv_obj_t * main_header_title;
    lv_obj_t * sidebar;
    lv_obj_t * sidebar_page;
    lv_obj_t * sidebar_header;
    lv_obj_t *
    sidebar_header_back_btn; /* a pointer to obj that on click triggers back Deletebtn event handler, can be same as 'sidebar_header' */
...
/**
* Get a pointer to main header back Deletebtn obj
* @param obj pointer to the menu
* @return pointer to main header back Deletebtn obj
*/
...
* Get a pointer to sidebar header obj
* @param obj pointer to the menu
* @return pointer to sidebar header back Deletebtn obj
*/
lv_obj_t * lv_menu_get_sidebar_header_back_btn(lv_obj_t * obj);

/**
 * Check if an obj is a root back Deletebtn
 * @param menu pointer to the menu
 * @return true if it is a root back Deletebtn
 */
