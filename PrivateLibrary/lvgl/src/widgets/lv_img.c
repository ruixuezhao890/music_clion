...
void lv_img_set_src(lv_obj_t * obj, const void * src)
{
    ...
    switch(src_type) {
        case LV_IMG_SRC_FILE:
            printf("lv_img_set_src: `LV_IMG_SRC_FILE` type found");
            break;
        case LV_IMG_SRC_VARIABLE:
            printf("lv_img_set_src: `LV_IMG_SRC_VARIABLE` type found");
            break;
        case LV_IMG_SRC_SYMBOL:
            printf("lv_img_set_src: `LV_IMG_SRC_SYMBOL` type found");
            break;
        default:
            printf("lv_img_set_src: unknown type");
    }
#endif
