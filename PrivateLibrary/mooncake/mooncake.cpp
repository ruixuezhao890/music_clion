...
APP_BASE *Mooncake::getCurrentApp() const {
    return CurrentAPP;
}

APP_BASE *Mooncake::getLastApp() const {
    return LastAPP;
}

void Mooncake::setCurrentApp(APP_BASE *currentApp) {
    CurrentAPP = currentApp;
}

void Mooncake::setLastApp(APP_BASE *lastApp) {
    LastAPP = lastApp;
}

const std::map<std::string, APP_BASE *> &Mooncake::getAppBaseHandle() const {
    return APP_BASEHandle;
}

void Mooncake::setAppBaseHandle(std::string name, APP_BASE * appBase) {
    APP_BASEHandle[name] = appBase;
}

pageManage *Mooncake::getPageManage() const {
    return PageManage;
}
